...
FILTER13="/scratch/tmp/a_toen03/Genomes/hg38/Canvas/customExclusion.bed"
...
dotnet $CANVAS Somatic-WGS \
  ...
  --somatic-vcf=VariantDir_${BASENAME}/Strelka2/Somatic/results/variants/somatic.snvs.vcf.gz \
